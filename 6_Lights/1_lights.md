بسیار خب! مبحث **نور (Lighting)** در پکیج `ursina` یکی از مباحث کلیدی برای زیبا و واقع‌گرایانه کردن بازی‌های سه‌بعدی است. 
...
در این آموزش قدم‌به‌قدم با هم پیش می‌رویم.
...
### تمرین برای شما:
یک صحنه بسازید که شامل ۳ شیء (مکعب، کره و استوانه) باشد. یک نور نقطه‌ای زرد رنگ بالای سر آنها قرار دهید و با کلیدهای W, A, S, D آن نور را حرکت دهید. (راهنمایی: در تابع `update()` از `held_keys['w']` استفاده کنید).

اگر سوالی در مورد تنظیمات سایه (`shadow_map_resolution`) یا نوع Collider دارید، خوشحال می‌شوم بیشتر توضیح بدهم! موفق باشید. 🚀
